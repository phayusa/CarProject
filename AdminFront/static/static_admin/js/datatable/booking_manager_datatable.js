...
(function ($) {
    ...
    var datatableInit = function () {
                ...
                columns: [
                    ...
                    // {data: 'date'},
                    {
                        ...
                        "render": function (value) {
                            ...
                            return dt.getDate() + "/" + ("0" + (getMonth() + 1)).slice(-2) + "/" + dt.getFullYear();
                        }
                    },
                    {data: 'client'},
                    // {data: 'arrive_time'},
                    {
                        ...
                        "render": function (value) {
                            ...
                            var dt = new Date(value);
                            return dt.getDate() + "/" + ("0" + (getMonth() + 1)).slice(-2) + "/" + dt.getFullYear()+" "+dt.getUTCHours()+"H"+dt.getUTCMinutes();
                        }
                    },
                    {data: 'status'},
                    {data: 'tt'}
        ...
        $('#booking_table tbody').on('click', 'button', function () {
        ...
        $("#booking_table_filter").addClass("col-md-10");
