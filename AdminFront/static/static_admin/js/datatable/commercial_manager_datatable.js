...
(function ($) {
    ...
    var datatableInit = function () {
        ...
        $('#commercial_table tbody').on('click', 'button', function () {
            // var data = bis.row($(this).parents('tr')).data();
            // alert("" + data["id"]);
            // $('#id01').modal('show');
            window.location.href = '/admin/commercial/'+bis.row($(this).parents('tr')).data()["id"];
            // $('#modalForm').getElementById("")
        });

        // Add the class for the search field is inside the table
        $("#commercial_table_filter").addClass("col-md-10");
