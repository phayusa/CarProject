...
(function ($) {
    ...
    var datatableInit = function () {
        ...
        $('#car_model_datatable tbody').on('click', 'button', function () {
            // var data = bis.row($(this).parents('tr')).data();
            // alert("" + data["id"]);
            // $('#id01').modal('show');
            window.location.href = '/admin/car-model/' + bis.row($(this).parents('tr')).data()["id"];
            // $('#modalForm').getElementById("")
        });

        // Add the class for the search field is inside the table
        $("#car_model_datatable_filter").addClass("col-md-10");
