...
(function ($) {
    ...
    var datatableInit = function () {
        ...
        var $table = $('#commercial_partener_table');
        // $table.dataTable({
        ...
        $('#commercial_partener_table tbody').on('click', 'button', function () {
            // var data = bis.row($(this).parents('tr')).data();
            // alert("" + data["id"]);
            // $('#id01').modal('show');
            window.location.href = '/partener/commercial/'+bis.row($(this).parents('tr')).data()["id"];
            // $('#modalForm').getElementById("")
        });

        // Add the class for the search field is inside the table
        $("#commercial_partener_table_filter").addClass("col-md-10");
