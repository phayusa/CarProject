...
(function ($) {
    ...
    var datatableInit = function () {
        ...
        $('#partener_table tbody').on('click', 'button', function () {
            // var data = bis.row($(this).parents('tr')).data();
            // alert("" + data["id"]);
            // $('#id01').modal('show');
            window.location.href = '/admin/partener/'+bis.row($(this).parents('tr')).data()["id"];
            // $('#modalForm').getElementById("")
        });

        // Add the class for the search field is inside the table
        $("#partener_table_filter").addClass("col-md-10");
